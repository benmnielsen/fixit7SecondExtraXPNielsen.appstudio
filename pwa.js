...
const cacheName = 'fixit7SecondExtraXPAnna-2020-10-04 16:45:45.003122'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7SecondExtraXPAnna'.length) === 'fixit7SecondExtraXPAnna') {
